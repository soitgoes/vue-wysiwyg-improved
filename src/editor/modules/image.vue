...
export default {
    ...
    computed: {
        ...
        dzMessageText() {
          return this.options.dropzoneMessage || "Click here to select an image ...";
        },
        ...
        dropzoneOptions () {
          return {
            ...
            dictDefaultMessage: `<i class="fa">${UPLOAD_ICON}</i><br>${this.dzMessageText}`,
    ...
    methods: {
        ...
        fileAdded (file) {
            ...
            if (this.options.removeDropzoneFiles === true) {
